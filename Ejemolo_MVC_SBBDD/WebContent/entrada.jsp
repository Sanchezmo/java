...
<%
	...
	if(!(error==null))// si esto es no falso, es decir, si existe el error, dependiendo de por donde nos entre el usuario.
	{
		out.println(error);// con esto evito que si no pongo el if  y solo pongo el out.print me ponga como mensaje null. 
