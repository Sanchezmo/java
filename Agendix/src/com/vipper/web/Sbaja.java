...
/**
 * Servlet implementation class Sbaja
 */
@WebServlet("/sbaja")
public class Sbaja extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			int exito=ab1.bajaContacto(id);
			if (exito>=1) {
				request.setAttribute("mensaje","Su gestión se ha realizado con éxito");
			}else {
				request.setAttribute("mensaje","Compruebe que el id introducido existe");
			}
